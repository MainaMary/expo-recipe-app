...
const styles = StyleSheet.create({
  ...
  btnWrapper: { backgroundColor: "orange", padding: 10, borderRadius: 5, marginTop: 20 },
  start: {
  ...
  return (
    ...
    >
      ...
      <View
        ...
        <Text
          style={styles.welcome}>Welcome to BaoBox Food app</Text>
        <Text style={styles.explore}>Explore delicious food</Text>
        <TouchableOpacity
